...
function Menu() {
  return (
    ...
    <MenuItem price="750" name="Beef Crunch Burger" img={item5} desc="Topped with crisp pepperoni, cheese slices, and onions."/>
    <MenuItem price="600" name="Veggie Burger" img={item6} desc="Topped with crisp lettuce, ripe tomato slices, and zesty pickles."/>
    {/* <MenuItem price="800" name="Chicken Burger" img={item1} desc="Topped with crisp lettuce, ripe tomato slices, and zesty pickles."/>
    <MenuItem price="800" name="Pepperoni Burger" img={item2} desc="Topped with crisp pepperoni, cheese slices, and onions."/>
    <MenuItem price="800" name="Chicken Burger" img={item1} desc="Topped with crisp lettuce, ripe tomato slices, and zesty pickles."/> */}
      </div>
    </div>
    </div>
